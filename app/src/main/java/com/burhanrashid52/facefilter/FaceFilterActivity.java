...
import com.burhanrashid52.facefilter.camera.CameraSourcePreview;
import com.burhanrashid52.facefilter.camera.GraphicOverlay;
...
public class FaceFilterActivity extends AppCompatActivity {
    com.burhanrashid52.facefilter.TextGraphic mTextGraphic;
...
CircleImageView circleImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_filter2);
        mPreview = (CameraSourcePreview) findViewById(R.id.preview);
        mGraphicOverlay = (GraphicOverlay) findViewById(R.id.faceOverlay);
        //mTextGraphic = new TextGraphic(mGraphicOverlay);
        //mGraphicOverlay.add(mTextGraphic);
circleImageView=findViewById(R.id.gotochat);
...
circleImageView.setOnClickListener(new View.OnClickListener() {
    ...
    private class GraphicTextTracker extends Tracker<String> {
        ...
        private com.burhanrashid52.facefilter.TextGraphic mTextGraphic ;

        GraphicTextTracker(GraphicOverlay overlay) {
            mOverlay = overlay;
            mTextGraphic = new com.burhanrashid52.facefilter.TextGraphic(overlay);
        }
